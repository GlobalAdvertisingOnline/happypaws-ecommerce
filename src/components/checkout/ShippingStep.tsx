  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        id={id}
        {...props}
        className={`rounded-lg border px-4 py-3 text-sm text-slate-900 transition-colors focus:border-brand-teal focus:outline-none focus:ring-2 focus:ring-brand-teal/20 ${
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <select
          ...
          className="rounded-lg border border-slate-200 px-4 py-3 text-sm text-slate-900 transition-colors focus:border-brand-teal focus:outline-none focus:ring-2 focus:ring-brand-teal/20"
        >
