            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${consent.analytics ? "bg-brand-teal" : "bg-slate-300"}`}
                >
                  <span
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative h-6 w-11 rounded-full transition-colors ${consent.marketing ? "bg-brand-teal" : "bg-slate-300"}`}
                >
                  <span
