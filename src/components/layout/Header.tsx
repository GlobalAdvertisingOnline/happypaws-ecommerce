...
export function Header() {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-8 md:flex">
            ...
            <button
              ...
              className="flex items-center justify-center rounded-lg p-2 text-slate-600 transition-colors hover:bg-slate-100 hover:text-brand-teal"
            ...
            <button
              onClick={openCart}
              className="relative flex items-center justify-center rounded-lg p-2 text-slate-600 transition-colors hover:bg-slate-100 hover:text-brand-teal"
            ...
            <Link
              href="/shop"
              className="rounded-lg bg-brand-teal px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-brand-teal-dark hover:shadow-md"
            >
              Shop Now
            </Link>
          </nav>

          {/* Mobile: Search + Cart + Toggle */}
        ...
        >
          <nav className="flex flex-col gap-3 px-4 pb-6 pt-4">
            ...
            <Link
              href="/shop"
              onClick={() => setMobileOpen(false)}
              className="mt-2 rounded-lg bg-brand-teal px-4 py-3 text-center text-base font-semibold text-white transition-all hover:bg-brand-teal-dark"
            >
              Shop Now
            </Link>
          </nav>
      ...
      {/* Search Dialog (rendered outside header for proper z-index stacking) */}
