    ...
    <section className="bg-brand-teal py-16 md:py-20">
      <div ref={sectionRef} className="scroll-reveal mx-auto max-w-7xl px-4 text-center md:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/tracking"
            className="btn-shine inline-flex w-full items-center justify-center rounded-lg bg-white px-8 py-3.5 text-base font-semibold text-brand-teal shadow-lg transition-all hover:bg-teal-50 hover:shadow-xl sm:w-auto"
          >
            Track Your Order
          </Link>
          <Link
