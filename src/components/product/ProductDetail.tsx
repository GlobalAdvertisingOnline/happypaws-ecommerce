    ...
    <div className="grid gap-8 md:grid-cols-2 md:gap-12 lg:gap-16">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-brand-teal">{product.category}</span>
          {product.isNew && (
            <span className="rounded-full bg-brand-teal px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-white">
              New
            </span>
          )}
        ...
        <div className="grid grid-cols-3 gap-3 rounded-xl border border-slate-100 bg-slate-50/50 p-4">
          ...
          <div className="flex flex-col items-center gap-1.5 text-center">
            <RotateCcw className="h-5 w-5 text-brand-teal" />
