    ...
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-2xl px-4 text-center md:px-6">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link
            href="/tracking"
            className="flex items-center gap-2 rounded-xl bg-brand-teal px-6 py-3.5 text-sm font-semibold text-white transition-all hover:bg-brand-teal-dark hover:shadow-md"
          >
            Track Your Order
        ...
        <p className="mt-8 text-sm text-slate-500">
          ...
          <a href="mailto:support@happypaws.shop" className="font-medium text-brand-teal hover:underline">
            support@happypaws.shop
          </a>{" "}
          or call{" "}
          <a href="tel:+18443082059" className="font-medium text-brand-teal hover:underline">
            (844) 308-2059
          </a>
        </p>
      </div>
