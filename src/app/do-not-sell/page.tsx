...
export const metadata: Metadata = {
  ...
  description:
    "Learn about your rights under the CCPA/CPRA to opt out of the sale or sharing of your personal information at HappyPaws.",
};
      ...
      <section className="bg-gradient-to-br from-slate-50 via-teal-50/50 to-white py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-4 text-center md:px-6 lg:px-8">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-teal/10">
            <ShieldAlert className="h-8 w-8 text-brand-teal" />
          </div>
