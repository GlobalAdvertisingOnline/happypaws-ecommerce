...
export const metadata: Metadata = {
  ...
  description:
    "Track your HappyPaws order in real time. Enter your tracking number to get instant shipping updates from USPS, UPS, FedEx, DHL, and 1,500+ carriers worldwide.",
};
      ...
      <section className="border-y border-slate-100 bg-slate-50 py-12">
        <div className="mx-auto max-w-7xl px-4 text-center md:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3 md:gap-4">
            ...
            <div className="rounded-lg border border-brand-teal/20 bg-brand-teal/5 px-4 py-2 text-sm font-semibold text-brand-teal">
              1,500+ More
            </div>
          </div>
        </div>
