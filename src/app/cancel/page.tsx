...
export const metadata: Metadata = {
  title: "Cancel Order",
  description:
    "Request to cancel your HappyPaws order. Fill out our cancellation form and we'll process your request within 24 hours.",
};
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-teal-50/50 to-white py-16 md:py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 text-center md:px-6 lg:px-8">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-teal/10">
            <XCircle className="h-8 w-8 text-brand-teal" />
          </div>
