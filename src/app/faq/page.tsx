...
export const metadata: Metadata = {
  ...
  description:
    "Find answers to common questions about orders, shipping, returns, refunds, payments, and more at HappyPaws.",
};
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "We accept Visa, Mastercard, American Express, and Discover for your convenience. All payments are processed securely through our encrypted checkout system with industry-standard SSL protection.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "You can reach our customer support team by email at support@happypaws.shop or by phone at (844) 308-2059. You can also send us a message through our contact page and we'll respond within 24 hours.",
...
export default function FAQPage() {
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-teal-50/50 to-white py-16 md:py-20">
      ...
      <section className="border-t border-slate-100 bg-slate-50 py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 text-center md:px-6 lg:px-8">
          ...
          <Link
            href="/contact"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-brand-teal px-8 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-teal/90"
          >
